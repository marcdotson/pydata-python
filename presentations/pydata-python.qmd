...
- Code is interactive -- leverage it to practice what you're learning
...
3. Download and install VS Code (visit [code.visualstudio.com](https://code.visualstudio.com)) and connect your GitHub account
4. Inside VS Code, clone the forked workshop repository and activate the project environment with `uv run`
5. Create a Python script or notebook and explore the included data
