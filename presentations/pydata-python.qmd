...
- “The second best programming language for everything”
  - Local installation (uv, conda, etc.)
  - Libraries, project/virtual environments (uv, venv, etc.), and Docker
  - Virtual machines (including Colab, GitHub)
- Not a knife, a Swiss Army knife — context matters for use
  - Notebooks (Jupyter, Marimo, Quarto) and scripts
  - “Data science involves coding, but it isn’t coding only”
