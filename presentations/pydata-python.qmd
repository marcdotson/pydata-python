...
2. Install Python using `uv python install` via the command line
3. Register for a GitHub account (visit [github.com](https://github.com)) and download this workshop repository (visit [github.com/marcdotson/pydata-python](https://github.com/marcdotson/pydata-python))
