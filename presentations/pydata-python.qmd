...
3. Register for a GitHub account (visit [github.com](https://github.com)) and fork a version of this workshop
4. Download and install VS Code (visit [code.visualstudio.com](https://code.visualstudio.com)) and connect your GitHub account
5. Inside VS Code, clone the forked workshop repository and activate the project environment with `uv run` via the terminal
6. Modify the Python script or notebook and explore the included data
